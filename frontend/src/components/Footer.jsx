      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link to="/kurikulum" className="hover:text-white transition">Kurikulum</Link></li>
            <li><Link to="/visi-misi" className="hover:text-white transition">Visi Misi</Link></li>
            <li><Link to="/kalender-akademik" className="hover:text-white transition">Kalender Akademik</Link></li>
          </ul>
        </div>
        <div>
