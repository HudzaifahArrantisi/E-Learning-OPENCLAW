...
const PostingOrmawa = () => {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      await api.post('/api/ormawa/posts', formData, {
          ...
          >
            <div className="space-y-6">
              ...
              <div className="group">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 text-lp-text bg-lp-surface/50 border border-lp-border rounded-2xl focus:bg-white focus:border-green-400 focus:ring-4 focus:ring-green-50 transition-all outline-none"
                  required
                />
              </div>
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  className="w-full px-5 py-4 text-lp-text bg-lp-surface/50 border border-lp-border rounded-2xl focus:bg-white focus:border-green-400 focus:ring-4 focus:ring-green-50 transition-all outline-none resize-none"
                  required
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-lp-text tracking-wide mb-2 uppercase">
                  Bukti / Pamflet <span className="text-lp-text3 text-xs font-normal lowercase ml-1">(Opsional, Maks. 10 gambar)</span>
                </label>
                
                <div className="relative border-2 border-dashed border-lp-borderA rounded-3xl p-8 hover:bg-green-50/40 hover:border-green-300 transition-colors group text-center cursor-pointer overflow-hidden">
                  <input
                    type="file"
                    accept="image/*"
                    multiple
                  ...
                  <div className="relative z-0">
                    <div className="w-14 h-14 bg-white shadow-sm border border-lp-border rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                      <FaUpload className="text-xl text-green-500" />
                    </div>
                    <p className="text-lp-text font-medium mb-1">Tarik & Lepas gambar ke sini</p>
                    <p className="text-sm text-lp-text3">atau klik untuk upload dari galeri (JPG, PNG)</p>
                  </div>
                </div>

                {/* File Counter & Quick Action */}
                {files.length > 0 && (
                  <div className="mt-4 flex items-center justify-between px-4 py-3 bg-green-50/60 border border-green-100 rounded-xl">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-4 pt-4 border-t border-lp-border">
              ...
              <button
                ...
                className="w-full sm:w-2/3 py-4 font-semibold text-white bg-green-600 hover:bg-green-700 rounded-2xl shadow-[0_8px_20px_rgba(22,163,74,0.25)] hover:shadow-[0_12px_25px_rgba(22,163,74,0.35)] hover:-translate-y-0.5 transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
              >
                {mutation.isPending ? (
