  ...
  return (
    <div className="flex min-h-screen bg-lp-bg font-sans font-light">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-[400px] bg-gradient-to-b from-green-50/60 via-white to-transparent pointer-events-none z-0" />
        ...
        <div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 mt-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-green-100/60 text-green-600 mb-4 ring-1 ring-green-200">
              <FaUpload className="text-2xl" />
            </div>
            <h1 className="text-3xl font-bold text-lp-text tracking-tight mb-2">Posting Aktivitas Ormawa</h1>
            <p className="text-lp-text2 font-light">Eksiskan organisasi mahasiswa Anda di linimasa kampus</p>
          </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-lp-text text-sm">{user?.name || 'Ormawa'}</p>
                    <p className="text-xs text-green-600 font-medium">Berapa detik yang lalu</p>
                  </div>
                </div>
                  ...
                  {isProcessing && !showSuccess && (
                    <div className="absolute inset-0 bg-black/20 flex flex-col items-center justify-center transition-opacity duration-300">
                      <div className="bg-white/95 backdrop-blur-md px-5 py-3 rounded-2xl shadow-xl flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold text-green-600">Memproses Posting...</span>
                      </div>
                    </div>
                  )}
                   ...
                   {uploadProgress < 100 ? (
                     <div className="w-full max-w-xs">
                       <div className="bg-gray-200 rounded-full h-2.5 mb-2 overflow-hidden shadow-inner">
                         <div className="bg-green-600 h-full rounded-full transition-all duration-300" style={{ width: `${uploadProgress}%` }}></div>
                       </div>
                       <p className="text-center text-xs font-semibold text-green-600">{uploadProgress}% Mengunggah...</p>
                     </div>
                   ) : isProcessing && !showSuccess ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-green-400 focus:ring-4 focus:ring-green-50 transition-all outline-none text-gray-800 placeholder-gray-400 font-medium"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  placeholder="Ceritakan detail event atau pengumuman..."
                  className="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-green-400 focus:ring-4 focus:ring-green-50 transition-all outline-none resize-none text-gray-800 placeholder-gray-400 leading-relaxed max-h-[300px]"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="relative border-2 border-dashed border-gray-300 rounded-2xl p-8 sm:p-10 hover:bg-green-50/50 hover:border-green-300 transition-colors group text-center cursor-pointer overflow-hidden bg-gray-50">
                  <input
                    type="file"
                    accept="image/*"
                    multiple
                  ...
                  <div className="relative z-0 flex flex-col items-center">
                    <div className="w-12 h-12 bg-white shadow-sm border border-gray-100 rounded-full flex items-center justify-center mb-3 group-hover:-translate-y-1 transition-transform duration-300">
                      <FaUpload className="text-lg text-green-500" />
                    </div>
                    <p className="text-gray-800 font-semibold mb-1 text-sm sm:text-base">Tarik & Lepas gambar ke sini</p>
                    <p className="text-xs sm:text-sm text-gray-500">atau klik untuk upload dari galeri (JPG, PNG)</p>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-100 mt-8">
              ...
              <button
                ...
                disabled={mutation.isPending}
                 className="flex-1 py-3.5 font-semibold text-white bg-green-600 hover:bg-green-700 rounded-xl shadow-sm hover:shadow-[0_4px_12px_rgba(22,163,74,0.3)] hover:-translate-y-0.5 transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex justify-center items-center"
              >
                {mutation.isPending ? (
      ...
      <AnimatePresence>
        {showSuccess && (
          ...
          >
            ...
            <div>
              <h4 className="font-bold text-sm tracking-tight border-b-0">Postingan Dibuat!</h4>
              <p className="text-xs text-lp-text2">Update Ormawa sukses diregistrasi ke sistem.</p>
            </div>
          </motion.div>
        )}
        ...
        {showError && (
          ...
          >
            ...
            <div>
              <h4 className="font-bold text-sm tracking-tight border-b-0">Gagal Post</h4>
