    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 max-w-2xl mx-auto pb-20">
        ...
        <div className="p-6">
          ...
          <p className="text-lp-text2 font-light mb-6">Kelola informasi profile Administrator</p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <a
              href="/admin/akun"
              className="bg-lp-accent text-white py-3 px-4 rounded-lg text-center hover:bg-lp-atext"
            >
              📱 Lihat Akun Saya
            </a>
          </div>
