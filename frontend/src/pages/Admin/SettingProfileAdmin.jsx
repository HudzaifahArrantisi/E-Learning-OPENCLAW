  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 max-w-2xl mx-auto pb-20">
        ...
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-2">Pengaturan Profile Admin</h1>
          <p className="text-gray-600 mb-6">Kelola informasi profile Administrator</p>
          ...
          <div className="mb-6 bg-white rounded-lg shadow-sm border p-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 flex items-center justify-center text-white text-xl font-bold">
                {previewImage ? (
              ...
              <div>
                <div className="font-bold">{formData.name || 'Administrator'}</div>
                <div className="text-sm text-gray-500">@{formData.username || 'username'}</div>
                <div className="text-xs text-gray-400">
                  Akan terlihat di: {window.location.origin}/profile/admin/{formData.username || 'username'}
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center space-x-6">
                <div className="relative">
                  {previewImage ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-gradient-to-r from-blue-500 to-blue-700 flex items-center justify-center text-white text-2xl font-bold">
                      {formData.name?.[0]?.toUpperCase() || 'A'}
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    placeholder="Contoh: Administrator Kampus"
                  />
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    URL: {window.location.origin}/profile/admin/{formData.username || 'username'}
                  </p>
                </div>
