...
const AkunAdmin = () => {
  ...
  const { profile, loading, reloadProfile } = useProfile('admin')
      ...
      <div className="flex-1 max-w-4xl mx-auto pb-20">
            ...
            <div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center gap-3 md:space-x-6 mb-4">
                  <h1 className="text-2xl font-bold text-gray-900">{profile?.name || 'Administrator'}</h1>
                ...
                <div className="space-y-2">
                  <p className="text-gray-800 font-medium">@{profile?.username || 'admin'}</p>
                  {profile?.bio && (
        ...
        <div className="bg-white rounded-lg shadow-sm border">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 text-sm">Kelola semua pengumuman dan postingan admin</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
            {posts.length > 0 ? (
              ...
              <div className="col-span-3 text-center py-12 text-gray-500">
                ...
                <div className="text-lg font-medium">Belum ada pengumuman</div>
                <p className="text-sm mt-2">Mulai bagikan pengumuman penting kampus</p>
