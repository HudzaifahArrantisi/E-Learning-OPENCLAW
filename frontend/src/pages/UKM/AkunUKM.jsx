  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 w-full max-w-5xl mx-auto p-4 sm:p-6 md:p-8">
        ...
        <div className="bg-lp-surface rounded-2xl shadow-xl p-5 sm:p-8 md:p-10 mb-8">
          <div className="flex flex-col md:flex-row gap-6 md:gap-10">
            <div className="mx-auto md:mx-0">
              {profile?.profile_picture ? (
                ...
                <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full bg-lp-bg flex items-center justify-center text-white text-4xl sm:text-6xl md:text-7xl font-bold">
                  {profile?.name?.[0] || 'U'}
                </div>
              )}
            </div>
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-base sm:text-xl md:text-2xl text-lp-text2 font-light mb-4 sm:mb-6 break-all">@{profile?.username}</p>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 md:gap-10 text-center mb-6 sm:mb-8">
                <div>
                  ...
                  <div className="text-lp-text2 font-light text-xs sm:text-sm md:text-base">Postingan</div>
                </div>
                <div>
                  <div className="text-xl sm:text-3xl md:text-4xl font-bold">{profile?.followers_count || 0}</div>
                  <div className="text-lp-text2 font-light text-xs sm:text-sm md:text-base">Pengikut</div>
                </div>
                <div>
                  <div className="text-xl sm:text-3xl md:text-4xl font-bold">{profile?.following_count || 0}</div>
                  <div className="text-lp-text2 font-light text-xs sm:text-sm md:text-base">Mengikuti</div>
                </div>
              </div>
