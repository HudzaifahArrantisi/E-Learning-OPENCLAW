      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto p-6 sm:p-10 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-light text-lp-text tracking-tight mb-3">Pengaturan Profile UKM</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            >
              <div className="bg-white border border-lp-border rounded-[2.5rem] p-8 shadow-[0_32px_64px_rgba(0,0,0,0.03)] text-center">
                ...
                <h3 className="text-2xl font-normal text-lp-text tracking-tight truncate">{formData.name || 'Nama UKM'}</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                    <div className="group">
                      ...
                      <input
                        ...
                        required
                        placeholder="NFSCC Organization"
                      />
                    </div>
