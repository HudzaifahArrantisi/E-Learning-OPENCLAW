...
const PostingUKM = () => {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await api.post('/api/ukm/posts', formData, {
        headers: { 'Content-Type': 'multipart/form-data' }
      })
    },
    
    onSuccess: () => {
      alert('Postingan UKM berhasil!')
      setTitle('')
      setContent('')
      setFiles([])
      setPreviews([])
      ...
      <div className="flex-1 lg:ml-64">
        ...
        <div className="max-w-4xl mx-auto p-6 mt-8">
          <div className="bg-lp-bg rounded-2xl p-8 mb-8 text-white text-center">
            <h1 className="text-4xl font-bold mb-4">Buat Postingan UKM</h1>
            <p className="text-lg opacity-90">Bagikan kegiatan dan prestasi unit kegiatan mahasiswa</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-lp-surface rounded-2xl shadow-xl p-8 space-y-8">
            <div>
              ...
              <input
                ...
                placeholder="Contoh: Open Recruitment UKM Musik 2025"
                className="w-full px-5 py-4 text-lg border-2 border-lp-border border rounded-xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-5 py-4 text-lg border-2 border-lp-border border rounded-xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition resize-none"
                required
              />
            </div>
            ...
            <div>
              ...
              {/* File Input */}
              <div className="border-2 border-dashed border-lp-border border rounded-2xl p-8 text-center mb-4 hover:border-purple-400 transition-colors">
                <input
                  type="file"
                  accept="image/*"
                  multiple
                  ...
                  id="file-upload-ukm"
                />
                <label htmlFor="file-upload-ukm" className="cursor-pointer">
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="flex-1 py-4 bg-lp-bg hover:from-purple-700 hover:to-pink-700 text-white text-lg font-bold rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-lp-border transform hover:scale-105 transition duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {mutation.isPending ? (
