  ...
  return (
    <div className="flex min-h-screen bg-lp-bg font-sans font-light">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-[400px] bg-gradient-to-b from-purple-50/60 via-white to-transparent pointer-events-none z-0" />
        ...
        <div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 mt-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-purple-100/60 text-purple-600 mb-4 ring-1 ring-purple-200">
              <FaUpload className="text-2xl" />
            </div>
            <h1 className="text-3xl font-bold text-lp-text tracking-tight mb-2">Posting Berita UKM</h1>
      ...
      <AnimatePresence>
        {showSuccess && (
          ...
          >
            ...
            <div>
              <h4 className="font-bold text-sm tracking-tight border-b-0">Mantap, Tepublish!</h4>
              <p className="text-xs text-lp-text2">Berita UKM telah dimumkan ke seluruh kampus.</p>
            </div>
          </motion.div>
        )}
        ...
        {showError && (
          ...
          >
            ...
            <div>
              <h4 className="font-bold text-sm tracking-tight border-b-0">Ups, Terjadi Kesalahan</h4>
